...
Path = "../FS2K/model/"
labelNO = 9
task =  classes[labelNO-3] + ".pt"
# task = "sketch_" + classes[labelNO-3] + ".pt"

totalEpoch = 60
param = Param()
net = MyVAE(in_channels=3, latent_dim=2048, param=param)
net.load_state_dict(torch.load(os.path.join(Path, "vae_2048.pt")), strict=False)
print("模型参数加载完毕")
net.to(device)
